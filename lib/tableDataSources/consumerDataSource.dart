...
class ConsumerDataSource extends DataGridSource {
  ConsumerDataSource({required this.consumerData}) {
    updateDataGridRow();
  }

  void updateDataGridRow() {
    _dataGridRow = consumerData
        .map<DataGridRow>((e) => DataGridRow(cells: [
              DataGridCell<String>(
                  columnName: 'profimg', value: e.profileImage),
              DataGridCell<String>(columnName: 'id', value: e.consumerID),
              DataGridCell<String>(columnName: 'name', value: e.consumerName),
              DataGridCell<String>(
  ...
  List<ConsumerModel> consumerData = [];
